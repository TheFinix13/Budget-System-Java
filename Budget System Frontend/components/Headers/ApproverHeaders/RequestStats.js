...
export default function RequestStats({handledRequests}) {
    ...
    const sortPendingRequests = () => {
        let sortedRequests = [...pendingRequest];
                ...
                <div className="px-4 md:px-10 mx-auto w-full">
                    {alert.type === 'success' && (
                        <div className="flex justify-center">
                            <div className="w-72">
                                <Alert severity="success" sx={{ backgroundColor: alert.color, color:'white' }}>
                                        ...
                                        {sortPendingRequests().map((row) => (
                                            <div className="w-full lg:w-6/12 xl:w-3/12 p-2">
                                                ...
                                                statDecline={() => handleDeny(row.budget_id)}
                                                 statIconName="fas fa-external-link"
