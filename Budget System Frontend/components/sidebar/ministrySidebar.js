...
export default function MinistrySidebar() {
    ...
    const { id } = router.query; // Retrieve the ministry ID from the router
            ...
            <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
                ...
                >
                    ...
                    <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                        <li className="items-center">
                            <Link
                                ...
                                className={
                                    ...
                                    (router.pathname.indexOf("/ministry/[id]") !== -1
                        ...
                        <li className="items-center">
                            <Link
                                href={`/ministry/department/department?id=${id}`}
                                className={
                                    "text-xs uppercase py-3 font-bold block " +
                                    (router.pathname.indexOf("/ministry/department/department") !== -1
                                        ? "text-lightBlue-500 hover:text-lightBlue-600"
                                        : "text-blueGray-700 hover:text-blueGray-500")
                                }>
                        ...
                        <li className="items-center">
                            <Link
                                href={`/ministry/division/division?id=${id}`}
                                className={
                                    "text-xs uppercase py-3 font-bold block " +
                                    (router.pathname.indexOf("/ministry/division/division") !== -1
                                        ? "text-lightBlue-500 hover:text-lightBlue-600"
                                        : "text-blueGray-700 hover:text-blueGray-500")
                                }>
                        ...
                        <li className="items-center">
                            <Link
                                href={`/ministry/profile?id=${id}`}
                                className={
                                    "text-xs uppercase py-3 font-bold block " +
                                    (router.asPath === `/ministry/profile?id=${id}`
                                        ? "text-lightBlue-500 hover:text-lightBlue-600"
                                        : "text-blueGray-700 hover:text-blueGray-500")
                                }>
                    ...
                    {/* Divider */}
                    <hr className="my-4 md:max-w-full"/>
                    {/* Heading */}
