...
//                                             (router.pathname.indexOf("/superAdmin/dashboard") !== -1
...
//                             <li className="items-center">
//                                 <Link href="/superAdmin/ministry">
//                                     <a
//                                         href="#pablo"
//                                         className={
//                                             "text-xs uppercase py-3 font-bold block " +
//                                             (router.pathname.indexOf("/superAdmin/ministry") !== -1
//                                                 ? "text-lightBlue-500 hover:text-lightBlue-600"
//                                                 : "text-blueGray-700 hover:text-blueGray-500")
//                                         }
//                                     >
...
//                                         className={
//                                             "text-xs uppercase py-3 font-bold block " +
//                                             (router.pathname.indexOf("/superAdmin/department") !== -1
//                                                 ? "text-lightBlue-500 hover:text-lightBlue-600"
//                                                 : "text-blueGray-700 hover:text-blueGray-500")
//                                         }
//                                     >
...
//                                         className={
//                                             "text-xs uppercase py-3 font-bold block " +
//                                             (router.pathname.indexOf("/superAdmin/division") !== -1
//                                                 ? "text-lightBlue-500 hover:text-lightBlue-600"
//                                                 : "text-blueGray-700 hover:text-blueGray-500")
//                                         }
//                                     >
